            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <section style="margin: 10px">
                        <div class="row">
                            <div v-for="(item,index) in youqinglianjieList" class="col-md-3">
                                <div class="gallery-demo" @click="jumpCheck('../youqinglianjie/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <img :src="item.youqinglianjiePhoto?item.youqinglianjiePhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                    <h4 class="p-mask">{{item.youqinglianjieName}}
                                        <span v-if="item.youqinglianjieNewMoney"> - ￥{{item.youqinglianjieNewMoney}}</span>
                                        <span v-else> - {{item.youqinglianjieValue}}</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right"><img src="../../xznstatic/img/insie1.png" alt="" /></span>
                            <span class="ng-inmod-the-bg ng-inmod-the-bg-right" aos="fade-up-left"><img src="../../xznstatic/img/insie2.png" alt="" /></span>
                            <span class="ng-inmod-the-cn" aos="fade-down">公告展示</span>
                            <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                        </div>
                        <span class="ng-inmod-thebor" aos="fade-up"></span>
                    </div>
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <section style="margin: 10px">
                        <div class="row">
                            <div v-for="(item,index) in gonggaoList" class="col-md-3">
                                <div class="gallery-demo" @click="jumpCheck('../gonggao/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <img :src="item.gonggaoPhoto?item.gonggaoPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                    <h4 class="p-mask">{{item.gonggaoName}}
                                        <span v-if="item.gonggaoNewMoney"> - ￥{{item.gonggaoNewMoney}}</span>
                                        <span v-else> - {{item.gonggaoValue}}</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request('youqinglianjie/list', 'get', {
            page: 1,
            limit: 8,
        }, function (res) {
            vue.youqinglianjieList = res.data.list;
            vue.$nextTick(() => {
