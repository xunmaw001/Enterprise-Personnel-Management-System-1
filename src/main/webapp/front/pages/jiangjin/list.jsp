            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">奖金展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jiangjinUuidName" id="jiangjinUuidName" placeholder="唯一编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="jiangjinName" id="jiangjinName" placeholder="奖金名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="jiangjinTypes" id="jiangjinTypes" lay-filter="jiangjinTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in jiangjinTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function jiangjinTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=jiangjin_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.jiangjinTypesList = res.data.list;
                }
            });
        }
        ...
        function pageList() {
            ...
            if (jquery('#jiangjinUuidName').val() != null && jquery('#jiangjinUuidName').val() != "" && jquery('#jiangjinUuidName').val() != "null" ) {
                param['jiangjinUuidName'] = jquery('#jiangjinUuidName').val();
            }
         
            if (jquery('#jiangjinName').val() != null && jquery('#jiangjinName').val() != "" && jquery('#jiangjinName').val() != "null" ) {
                param['jiangjinName'] = jquery('#jiangjinName').val();
            }
         
            var jiangjinTypes = $("#jiangjinTypes").find("option:selected").val();
            if (jiangjinTypes != null && jiangjinTypes != "" && jiangjinTypes != "null") {
                param['jiangjinTypes'] = jiangjinTypes;
            }
                                        

            // 获取列表数据
            http.request('jiangjin/list', 'get', param, function(res) {
