            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">任务展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="renwuUuidNumber" id="renwuUuidNumber" placeholder="任务编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="renwuName" id="renwuName" placeholder="任务标题" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="renwuTypes" id="renwuTypes" lay-filter="renwuTypes">
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#renwuUuidNumber').val() != null && jquery('#renwuUuidNumber').val() != "" && jquery('#renwuUuidNumber').val() != "null" ) {
                param['renwuUuidNumber'] = jquery('#renwuUuidNumber').val();
            }
         
            if (jquery('#renwuName').val() != null && jquery('#renwuName').val() != "" && jquery('#renwuName').val() != "null" ) {
                param['renwuName'] = jquery('#renwuName').val();
            }
         
            var renwuTypes = $("#renwuTypes").find("option:selected").val();
            if (renwuTypes != null && renwuTypes != "" && renwuTypes != "null") {
                param['renwuTypes'] = renwuTypes;
            }
                                        

            // 获取列表数据
            http.request('renwu/list', 'get', param, function(res) {
