            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">培训计划展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="peixunjihuaUuidNumber" id="peixunjihuaUuidNumber" placeholder="培训计划编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
     
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">培训计划标题</label>
                          <div class="layui-input-inline">
                              <input type="text" name="peixunjihuaName" id="peixunjihuaName" placeholder="培训计划标题" autocomplete="off" class="layui-input">
                          </div>
                      </div>
     
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">培训计划类型</label>
                          <div class="layui-input-inline">
                              <select name="peixunjihuaTypes" id="peixunjihuaTypes" lay-filter="peixunjihuaTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in peixunjihuaTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            peixunjihuaTypesList : [],
            peixunjihuaTypes: 0,//类型
            limit: 8,
    ...
    // 当前表的字典表
        ...
        function peixunjihuaTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=peixunjihua_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.peixunjihuaTypesList = res.data.list;
                }
            });
        }
        ...
        function pageList() {
            ...
            if (jquery('#peixunjihuaUuidNumber').val() != null && jquery('#peixunjihuaUuidNumber').val() != "" && jquery('#peixunjihuaUuidNumber').val() != "null" ) {
                param['peixunjihuaUuidNumber'] = jquery('#peixunjihuaUuidNumber').val();
            }
         
            if (jquery('#peixunjihuaName').val() != null && jquery('#peixunjihuaName').val() != "" && jquery('#peixunjihuaName').val() != "null" ) {
                param['peixunjihuaName'] = jquery('#peixunjihuaName').val();
            }
         
            var peixunjihuaTypes = $("#peixunjihuaTypes").find("option:selected").val();
            if (peixunjihuaTypes != null && peixunjihuaTypes != "" && peixunjihuaTypes != "null") {
                param['peixunjihuaTypes'] = peixunjihuaTypes;
            }
                                        

            // 获取列表数据
            http.request('peixunjihua/list', 'get', param, function(res) {
