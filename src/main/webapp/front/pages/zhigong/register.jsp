            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">职工姓名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhigongName" id="zhigongName"  placeholder="职工姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">职工手机号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhigongPhone" id="zhigongPhone"  lay-verify="phone|required"   placeholder="职工手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">职工身份证号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zhigongIdNumber" id="zhigongIdNumber"  lay-verify="identity|required"   placeholder="职工身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
...
<!-- 邮箱 -->
                <div class="layui-form-item" pane>
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="zhigongEmail" id="zhigongEmail"  lay-verify="email|required"   placeholder="电子邮箱" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">部门:</span>
                        <div class="layui-input-inline">
                            <select name="bumenTypes" id="bumenTypes" lay-filter="bumenTypes" style="width: 600px;">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">职位:</span>
                        <div class="layui-input-inline">
                            <select name="zhiweiTypes" id="zhiweiTypes" lay-filter="zhiweiTypes" style="width: 600px;">
