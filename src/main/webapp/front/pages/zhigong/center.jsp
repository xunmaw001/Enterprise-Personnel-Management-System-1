    ...
    <ul class="layui-nav layui-nav-tree">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhigongName" id="zhigongName" lay-verify="required" placeholder="职工姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhigongPhone" id="zhigongPhone"  lay-verify="required|phone"   placeholder="职工手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhigongIdNumber" id="zhigongIdNumber"  lay-verify="required|identity"   placeholder="职工身份证号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="zhigongPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="zhigongPhoto" name="zhigongPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="zhigongEmail" id="zhigongEmail"  lay-verify="required|email"   placeholder="电子邮箱" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="bumenTypes" id="bumenTypes" disabled>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="zhiweiTypes" id="zhiweiTypes" disabled>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`zhigong/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#zhigongPhotoImg").attr("src", data.data.zhigongPhoto);
                });
