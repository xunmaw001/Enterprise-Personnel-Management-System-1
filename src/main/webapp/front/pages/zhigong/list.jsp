            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">职工展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="zhigongName" id="zhigongName" placeholder="职工姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function bumenTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=bumen_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function pageList() {
            ...
            if (jquery('#zhigongName').val() != null && jquery('#zhigongName').val() != "" && jquery('#zhigongName').val() != "null" ) {
                param['zhigongName'] = jquery('#zhigongName').val();
            }
                                                 
            var bumenTypes = $("#bumenTypes").find("option:selected").val();
            if (bumenTypes != null && bumenTypes != "" && bumenTypes != "null") {
                param['bumenTypes'] = bumenTypes;
            }
         
            var zhiweiTypes = $("#zhiweiTypes").find("option:selected").val();
            if (zhiweiTypes != null && zhiweiTypes != "" && zhiweiTypes != "null") {
                param['zhiweiTypes'] = zhiweiTypes;
            }
        

            // 获取列表数据
            http.request('zhigong/list', 'get', param, function(res) {
