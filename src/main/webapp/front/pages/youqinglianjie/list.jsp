            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">友情链接展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="youqinglianjieName" id="youqinglianjieName" placeholder="友情链接名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
             
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">友情链接类型</label>
                          <div class="layui-input-inline">
                              <select name="youqinglianjieTypes" id="youqinglianjieTypes" lay-filter="youqinglianjieTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in youqinglianjieTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
                        ...
                        <div class="article-list">
                            <ul class="after">
                                <li v-for="(item,index) in dataList" v-bind:key="index">
                                    <a target="_self" :href="'../youqinglianjie/detail.jsp?id='+item.id">
                                        <img width="180" class="fl" :src="item.youqinglianjiePhoto" />
                                        <h5>{{item.youqinglianjieName}}</h5>
                                        <p class="time-sour">
                                            <span>发布时间：{{item.insertTime}} </span>
                                        </p>
                                        <p class="reamk">{{item.youqinglianjieContent|subString}}</p>
                                    </a>
                                </li>
                            </ul>
                            <div class="pages">
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            youqinglianjieTypesList : [],
            youqinglianjieTypes: 0,//类型
            limit: 8,
    ...
    // 当前表的字典表
        ...
        function youqinglianjieTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=youqinglianjie_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.youqinglianjieTypesList = res.data.list;
                }
            });
        }
        ...
        function pageList() {
            ...
            if (jquery('#youqinglianjieName').val() != null && jquery('#youqinglianjieName').val() != "" && jquery('#youqinglianjieName').val() != "null" ) {
                param['youqinglianjieName'] = jquery('#youqinglianjieName').val();
            }
                         
            var youqinglianjieTypes = $("#youqinglianjieTypes").find("option:selected").val();
            if (youqinglianjieTypes != null && youqinglianjieTypes != "" && youqinglianjieTypes != "null") {
                param['youqinglianjieTypes'] = youqinglianjieTypes;
            }
                

            // 获取列表数据
            http.request('youqinglianjie/list', 'get', param, function(res) {
