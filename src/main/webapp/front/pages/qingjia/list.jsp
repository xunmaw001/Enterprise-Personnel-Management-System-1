            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">请假展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="qingjiaName" id="qingjiaName" placeholder="请假名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="qingjiaTypes" id="qingjiaTypes" lay-filter="qingjiaTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in qingjiaTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="qingjiaYesnoTypes" id="qingjiaYesnoTypes" lay-filter="qingjiaYesnoTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in qingjiaYesnoTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function qingjiaTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=qingjia_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function qingjiaYesnoTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=qingjia_yesno_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function pageList() {
            ...
            if (jquery('#qingjiaName').val() != null && jquery('#qingjiaName').val() != "" && jquery('#qingjiaName').val() != "null" ) {
                param['qingjiaName'] = jquery('#qingjiaName').val();
            }
         
            var qingjiaTypes = $("#qingjiaTypes").find("option:selected").val();
            if (qingjiaTypes != null && qingjiaTypes != "" && qingjiaTypes != "null") {
                param['qingjiaTypes'] = qingjiaTypes;
            }
                                         
            var qingjiaYesnoTypes = $("#qingjiaYesnoTypes").find("option:selected").val();
            if (qingjiaYesnoTypes != null && qingjiaYesnoTypes != "" && qingjiaYesnoTypes != "null") {
                param['qingjiaYesnoTypes'] = qingjiaYesnoTypes;
            }
                        

            // 获取列表数据
            http.request('qingjia/list', 'get', param, function(res) {
