            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">招聘计划展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="zhaopinjihuaUuidName" id="zhaopinjihuaUuidName" placeholder="招聘计划编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="zhaopinjihuaName" id="zhaopinjihuaName" placeholder="招聘计划名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
     
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">招聘计划类型</label>
                          <div class="layui-input-inline">
                              <select name="zhaopinjihuaTypes" id="zhaopinjihuaTypes" lay-filter="zhaopinjihuaTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in zhaopinjihuaTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            zhaopinjihuaTypesList : [],
            zhiweiTypesList : [],
            zhaopinjihuaTypes: 0,//类型
            limit: 8,
    ...
    // 当前表的字典表
        ...
        function zhaopinjihuaTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhaopinjihua_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.zhaopinjihuaTypesList = res.data.list;
                }
            });
        }
        // 招聘职位的查询
        ...
        function pageList() {
            ...
            if (jquery('#zhaopinjihuaUuidName').val() != null && jquery('#zhaopinjihuaUuidName').val() != "" && jquery('#zhaopinjihuaUuidName').val() != "null" ) {
                param['zhaopinjihuaUuidName'] = jquery('#zhaopinjihuaUuidName').val();
            }
         
            if (jquery('#zhaopinjihuaName').val() != null && jquery('#zhaopinjihuaName').val() != "" && jquery('#zhaopinjihuaName').val() != "null" ) {
                param['zhaopinjihuaName'] = jquery('#zhaopinjihuaName').val();
            }
         
            var zhaopinjihuaTypes = $("#zhaopinjihuaTypes").find("option:selected").val();
            if (zhaopinjihuaTypes != null && zhaopinjihuaTypes != "" && zhaopinjihuaTypes != "null") {
                param['zhaopinjihuaTypes'] = zhaopinjihuaTypes;
            }
                                        

            // 获取列表数据
            http.request('zhaopinjihua/list', 'get', param, function(res) {
