            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">薪资展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="xinziUuidNumber" id="xinziUuidNumber" placeholder="薪资编号" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="xinziName" id="xinziName" placeholder="标题" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="month" name="xinziMonth" id="xinziMonth" placeholder="月份" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#xinziUuidNumber').val() != null && jquery('#xinziUuidNumber').val() != "" && jquery('#xinziUuidNumber').val() != "null" ) {
                param['xinziUuidNumber'] = jquery('#xinziUuidNumber').val();
            }
         
            if (jquery('#xinziName').val() != null && jquery('#xinziName').val() != "" && jquery('#xinziName').val() != "null" ) {
                param['xinziName'] = jquery('#xinziName').val();
            }
         
            if (jquery('#xinziMonth').val() != null && jquery('#xinziMonth').val() != "" && jquery('#xinziMonth').val() != "null" ) {
                param['xinziMonth'] = jquery('#xinziMonth').val();
            }
                                                                

            // 获取列表数据
            http.request('xinzi/list', 'get', param, function(res) {
