...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">培训计划管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">培训计划列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">培训计划列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="peixunjihuaUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="培训计划编号" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        培训计划标题
                                        <div class="layui-input-inline">
                                            <input type="text" id="peixunjihuaNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="培训计划标题" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        培训计划类型
                                        <div class="layui-input-inline">
                                            <select name="peixunjihuaTypesSelectSearch"  style="width: 150px;" id="peixunjihuaTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //培训计划编号
            var peixunjihuaUuidNumberSearchInput = $('#peixunjihuaUuidNumberSearch');
            if( peixunjihuaUuidNumberSearchInput != null){
                if (peixunjihuaUuidNumberSearchInput.val() != null && peixunjihuaUuidNumberSearchInput.val() != '') {
                    searchForm.peixunjihuaUuidNumber = $('#peixunjihuaUuidNumberSearch').val();
                }
            }
     
            //培训计划标题
            var peixunjihuaNameSearchInput = $('#peixunjihuaNameSearch');
            if( peixunjihuaNameSearchInput != null){
                if (peixunjihuaNameSearchInput.val() != null && peixunjihuaNameSearchInput.val() != '') {
                    searchForm.peixunjihuaName = $('#peixunjihuaNameSearch').val();
                }
            }
     
                //培训计划类型
            var peixunjihuaTypesSelectSearchInput = document.getElementById("peixunjihuaTypesSelectSearch");
            if(peixunjihuaTypesSelectSearchInput != null){
                var peixunjihuaTypesIndex = peixunjihuaTypesSelectSearchInput.selectedIndex;
                if( peixunjihuaTypesIndex  != 0){
                    searchForm.peixunjihuaTypes= document.getElementById("peixunjihuaTypesSelectSearch").options[peixunjihuaTypesIndex].value;
                }
            }
                                getDataList();
        }
        ...
        function getDataList() {
            http("peixunjihua/page", "GET", {
                ...
                peixunjihuaDelete: 1,
                //本表的
                peixunjihuaUuidNumber: searchForm.peixunjihuaUuidNumber,
                peixunjihuaName: searchForm.peixunjihuaName,
                peixunjihuaTypes: searchForm.peixunjihuaTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //培训计划编号
            var peixunjihuaUuidNumberCell = document.createElement('td');
            peixunjihuaUuidNumberCell.innerHTML = item.peixunjihuaUuidNumber;
            row.appendChild(peixunjihuaUuidNumberCell);


            //培训计划标题
            var peixunjihuaNameCell = document.createElement('td');
            peixunjihuaNameCell.innerHTML = item.peixunjihuaName;
            row.appendChild(peixunjihuaNameCell);


            //培训计划类型
            var peixunjihuaTypesCell = document.createElement('td');
            peixunjihuaTypesCell.innerHTML = item.peixunjihuaValue;
            row.appendChild(peixunjihuaTypesCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("peixunjihua/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addpeixunjihua", "addpeixunjihua");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function peixunjihuaTypesSelectSearch() {
            var peixunjihuaTypesSelectSearch = document.getElementById('peixunjihuaTypesSelectSearch');
            if(peixunjihuaTypesSelectSearch != null) {
                peixunjihuaTypesSelectSearch.add(new Option('-请选择-',''));
                if (peixunjihuaTypesOptions != null && peixunjihuaTypesOptions.length > 0){
                    for (var i = 0; i < peixunjihuaTypesOptions.length; i++) {
                            peixunjihuaTypesSelectSearch.add(new Option(peixunjihuaTypesOptions[i].indexName,peixunjihuaTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询当前表搜索条件所有列表
            function peixunjihuaTypesSelect() {
                //填充下拉框选项
                http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=peixunjihua_types", "GET", {}, (res) => {
                    if(res.code == 0){
                        peixunjihuaTypesOptions = res.data.list;
                    }
                });
            }
