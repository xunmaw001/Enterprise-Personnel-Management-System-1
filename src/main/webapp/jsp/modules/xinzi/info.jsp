                                ...
                                <input id="zhigongId" name="zhigongId" v-model="ruleForm.zhigongId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="xinziUuidNumber" name="xinziUuidNumber" class="form-control"
                                               v-model="ruleForm.xinziUuidNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="xinziName" name="xinziName" class="form-control"
                                               v-model="ruleForm.xinziName" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>月份</label>
                                        <input style="width: 450px" id="xinziMonth" name="xinziMonth" class="form-control"
                                               v-model="ruleForm.xinziMonth" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jibenJine" name="jibenJine" class="form-control"
                                               v-model="ruleForm.jibenJine" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jixiaoJine" name="jixiaoJine" class="form-control"
                                               v-model="ruleForm.jixiaoJine" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="butieJine" name="butieJine" class="form-control"
                                               v-model="ruleForm.butieJine" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="shifaJine" name="shifaJine" class="form-control"
                                               v-model="ruleForm.shifaJine" readonly>
                                    </div>
