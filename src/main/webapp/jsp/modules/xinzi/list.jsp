...
<!--/Pre Loader -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="xinziUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="薪资编号" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        标题
                                        <div class="layui-input-inline">
                                            <input type="text" id="xinziNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        月份
                                        <div class="layui-input-inline">
                                            <input type="month" id="xinziMonthSearch" style="width: 140px;" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //薪资编号
            var xinziUuidNumberSearchInput = $('#xinziUuidNumberSearch');
            if( xinziUuidNumberSearchInput != null){
                if (xinziUuidNumberSearchInput.val() != null && xinziUuidNumberSearchInput.val() != '') {
                    searchForm.xinziUuidNumber = $('#xinziUuidNumberSearch').val();
                }
            }
     
            //标题
            var xinziNameSearchInput = $('#xinziNameSearch');
            if( xinziNameSearchInput != null){
                if (xinziNameSearchInput.val() != null && xinziNameSearchInput.val() != '') {
                    searchForm.xinziName = $('#xinziNameSearch').val();
                }
            }
     
            //月份
            var xinziMonthSearchInput = $('#xinziMonthSearch');
            if( xinziMonthSearchInput != null){
                if (xinziMonthSearchInput.val() != null && xinziMonthSearchInput.val() != '') {
                    searchForm.xinziMonth = $('#xinziMonthSearch').val();
                }
            }
                                            getDataList();
        }
        ...
        function getDataList() {
            http("xinzi/page", "GET", {
                ...
                xinziDelete: 1,
                //本表的
                xinziUuidNumber: searchForm.xinziUuidNumber,
                xinziName: searchForm.xinziName,
                xinziMonth: searchForm.xinziMonth,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //薪资编号
            var xinziUuidNumberCell = document.createElement('td');
            xinziUuidNumberCell.innerHTML = item.xinziUuidNumber;
            row.appendChild(xinziUuidNumberCell);


            //标题
            var xinziNameCell = document.createElement('td');
            xinziNameCell.innerHTML = item.xinziName;
            row.appendChild(xinziNameCell);


            //月份
            var xinziMonthCell = document.createElement('td');
            xinziMonthCell.innerHTML = item.xinziMonth;
            row.appendChild(xinziMonthCell);


            //基本工资
            var jibenJineCell = document.createElement('td');
            jibenJineCell.innerHTML = item.jibenJine;
            row.appendChild(jibenJineCell);
            ...
            //绩效
            var jixiaoJineCell = document.createElement('td');
            jixiaoJineCell.innerHTML = item.jixiaoJine;
            row.appendChild(jixiaoJineCell);


            //补贴
            var butieJineCell = document.createElement('td');
            butieJineCell.innerHTML = item.butieJine;
            row.appendChild(butieJineCell);


            //实发
            var shifaJineCell = document.createElement('td');
            shifaJineCell.innerHTML = item.shifaJine;
            row.appendChild(shifaJineCell);
