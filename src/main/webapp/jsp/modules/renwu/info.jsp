            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">任务登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="zhigongId" name="zhigongId" v-model="ruleForm.zhigongId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="renwuUuidNumber" name="renwuUuidNumber" class="form-control"
                                               v-model="ruleForm.renwuUuidNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="renwuName" name="renwuName" class="form-control"
                                               v-model="ruleForm.renwuName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>任务类型</label>
                                    <input style="width: 450px" id="renwuValue" name="renwuValue" class="form-control"
                                           v-model="ruleForm.renwuValue" readonly>
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.renwuContent != null && ruleForm.renwuContent != 'null' && ruleForm.renwuContent != '') {
            var renwuContentUeditor = UE.getEditor('renwuContentEditor');
                renwuContentUeditor.ready(function () {
                    ...
                    renwuContentUeditor.setDisabled('fullscreen');
            });
        }
    }
