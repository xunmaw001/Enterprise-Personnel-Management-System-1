...
<!--/Pre Loader -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="renwuUuidNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="任务编号" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        任务标题
                                        <div class="layui-input-inline">
                                            <input type="text" id="renwuNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="任务标题" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        任务类型
                                        <div class="layui-input-inline">
                                            <select name="renwuTypesSelectSearch"  style="width: 150px;" id="renwuTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //任务编号
            var renwuUuidNumberSearchInput = $('#renwuUuidNumberSearch');
            if( renwuUuidNumberSearchInput != null){
                if (renwuUuidNumberSearchInput.val() != null && renwuUuidNumberSearchInput.val() != '') {
                    searchForm.renwuUuidNumber = $('#renwuUuidNumberSearch').val();
                }
            }
     
            //任务标题
            var renwuNameSearchInput = $('#renwuNameSearch');
            if( renwuNameSearchInput != null){
                if (renwuNameSearchInput.val() != null && renwuNameSearchInput.val() != '') {
                    searchForm.renwuName = $('#renwuNameSearch').val();
                }
            }
        ...
        function getDataList() {
            http("renwu/page", "GET", {
                ...
                renwuDelete: 1,
                //本表的
                renwuUuidNumber: searchForm.renwuUuidNumber,
                renwuName: searchForm.renwuName,
        ...
        function setDataRow(item, number) {
            ...
            //任务编号
            var renwuUuidNumberCell = document.createElement('td');
            renwuUuidNumberCell.innerHTML = item.renwuUuidNumber;
            row.appendChild(renwuUuidNumberCell);


            //任务标题
            var renwuNameCell = document.createElement('td');
            renwuNameCell.innerHTML = item.renwuName;
            row.appendChild(renwuNameCell);
    ...
    //填充本表搜索下拉框
        ...
        function renwuTypesSelectSearch() {
            ...
            if(renwuTypesSelectSearch != null) {
                renwuTypesSelectSearch.add(new Option('-请选择-',''));
