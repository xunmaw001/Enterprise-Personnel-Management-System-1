                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">打卡列表</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(zhigongPhotoCell);
                ...
                //打卡照片
            var dakaPhotoCell = document.createElement('td');
            var dakaPhotoImg = document.createElement('img');
            var dakaPhotoImgValue = item.dakaPhoto;
            if(dakaPhotoImgValue !=null && dakaPhotoImgValue !='' && dakaPhotoImgValue !='null'){
                dakaPhotoImg.setAttribute('src', dakaPhotoImgValue);
                dakaPhotoImg.setAttribute('height', 100);
                dakaPhotoImg.setAttribute('width', 100);
                dakaPhotoCell.appendChild(dakaPhotoImg);
            }else{
                dakaPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(dakaPhotoCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("daka/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("adddaka", "adddaka");
            window.location.href = "add-or-update.jsp"
        }
