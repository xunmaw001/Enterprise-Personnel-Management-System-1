...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">职工列表</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //职工身份证号
            var zhigongIdNumberCell = document.createElement('td');
            zhigongIdNumberCell.innerHTML = item.zhigongIdNumber;
            row.appendChild(zhigongIdNumberCell);
            ...
            //电子邮箱
            var zhigongEmailCell = document.createElement('td');
            zhigongEmailCell.innerHTML = item.zhigongEmail;
            row.appendChild(zhigongEmailCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("zhigong/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addzhigong", "addzhigong");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function resetPassword(id) {
            http("zhigong/resetPassword", "GET",{
                id:id
            }, (res) => {
                if(res.code == 0){
                    getDataList();
