            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">职工登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="zhigongIdNumber" name="zhigongIdNumber" class="form-control"
                                               v-model="ruleForm.zhigongIdNumber" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="zhigongEmail" name="zhigongEmail" class="form-control"
                                               v-model="ruleForm.zhigongEmail" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>部门</label>
                                    <input style="width: 450px" id="bumenValue" name="bumenValue" class="form-control"
