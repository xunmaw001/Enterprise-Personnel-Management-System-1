            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">职工管理</li>
                        <li class="breadcrumb-item active">编辑职工</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 zhigongNameDiv">
                                        <label>职工姓名</label>
                                        <input style="width: 450px" id="zhigongName" name="zhigongName" class="form-control"
                                               placeholder="职工姓名">
                                    </div>
                                    <div class="form-group col-md-6 zhigongPhoneDiv">
                                        <label>职工手机号</label>
                                    ...
                                    <div class="form-group col-md-6 zhigongIdNumberDiv">
                                        <label>职工身份证号</label>
                                        <input style="width: 450px" id="zhigongIdNumber" name="zhigongIdNumber" class="form-control"
                                               onchange="zhigongIdNumberChickValue(this)"  placeholder="职工身份证号">
                                    </div>
                                    <div class="form-group col-md-6 zhigongPhotoDiv">
                                        <label>职工头像</label>
                                        <img id="zhigongPhotoImg" src="" width="100" height="100">
                                        <input name="file" type="file" id="zhigongPhotoupload"
                                               class="form-control-file">
                                        <input name="zhigongPhoto" id="zhigongPhoto-input" type="hidden">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 zhigongEmailDiv">
                                        <label>电子邮箱</label>
                                        <input style="width: 450px" id="zhigongEmail" name="zhigongEmail" class="form-control"
                                               placeholder="电子邮箱">
                                    </div>
                                    <div class="form-group col-md-6 bumenTypesDiv">
                                        <label>部门</label>
                                        <select style="width: 450px" id="bumenTypesSelect" name="bumenTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("zhigong/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addzhigong');
    ...
    // 获取当前详情
    function getDetails() {
        var addzhigong = window.sessionStorage.getItem("addzhigong");
        if (addzhigong != null && addzhigong != "" && addzhigong != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("zhigong/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $('#bumenTypesSelect').attr('style', 'pointer-events:none;width:450px;');
            $('#zhiweiTypesSelect').attr('style', 'pointer-events:none;width:450px;');
        }
        else{
            // alert("未知情况.......");
