...
public class PeixunjihuaView extends PeixunjihuaEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 培训计划类型的值
		*/
		private String peixunjihuaValue;
	...
	public PeixunjihuaView(PeixunjihuaEntity peixunjihuaEntity) {
		try {
			...
			* 获取： 培训计划类型的值
			*/
			public String getPeixunjihuaValue() {
				return peixunjihuaValue;
			}
			/**
			* 设置： 培训计划类型的值
			*/
			public void setPeixunjihuaValue(String peixunjihuaValue) {
				this.peixunjihuaValue = peixunjihuaValue;
			}
