 ...
 */
@TableName("zhigong")
public class ZhigongEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ZhigongEntity() {

	}

	public ZhigongEntity(T t) {
		try {
    ...
    public String toString() {
        return "Zhigong{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", zhigongName=" + zhigongName +
            ", zhigongPhone=" + zhigongPhone +
            ", zhigongIdNumber=" + zhigongIdNumber +
            ", zhigongPhoto=" + zhigongPhoto +
            ", sexTypes=" + sexTypes +
            ", zhigongEmail=" + zhigongEmail +
