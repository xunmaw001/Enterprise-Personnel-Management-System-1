    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(liuyan !=null){
            ...
            BeanUtils.copyProperties( liuyan , view );//把实体数据重构到view中
                ...
                //级联表
                ZhigongEntity zhigong = zhigongService.selectById(liuyan.getZhigongId());
                if(zhigong != null){
    ...
    */
    ...
    public R save(@RequestBody LiuyanEntity liuyan, HttpServletRequest request){
        ...
        if(false)
            ...
            liuyan.setZhigongId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<LiuyanEntity> queryWrapper = new EntityWrapper<LiuyanEntity>()
            .eq("zhigong_id", liuyan.getZhigongId())
...
//                            liuyanEntity.setZhigongId(Integer.valueOf(data.get(0)));   //职工 要改的
