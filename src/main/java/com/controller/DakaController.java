    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(daka !=null){
            ...
            BeanUtils.copyProperties( daka , view );//把实体数据重构到view中
                ...
                //级联表
                ZhigongEntity zhigong = zhigongService.selectById(daka.getZhigongId());
                if(zhigong != null){
    ...
    */
    ...
    public R save(@RequestBody DakaEntity daka, HttpServletRequest request){
        ...
        if(false)
            ...
            daka.setZhigongId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<DakaEntity> queryWrapper = new EntityWrapper<DakaEntity>()
            .eq("zhigong_id", daka.getZhigongId())
...
//                            dakaEntity.setZhigongId(Integer.valueOf(data.get(0)));   //职工 要改的
//                            dakaEntity.setDakaPhoto("");//详情和图片
